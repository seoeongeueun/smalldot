...
export default function Menu() {
  ...
  return (
    ...
    >
      <article className="uppercase min-w-1/2 max-w-[40rem] py-4 h-full rounded-sm bg-black/70 border border-2 border-cyan-300 outline outline-px outline-white flex flex-row">
